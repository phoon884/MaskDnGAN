...
parser.add_argument('--input_dir', type=str,  help='input path')
...
trainBackWarp      = dataloader.backWarp((1920, 1080), device)
...
images = []
for i in range(1,11):
    image_raw = Image.open(os.path.join(args.output_dir,'%04d' % i))
